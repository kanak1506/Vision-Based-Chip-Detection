...
def create_cutting_sector_mask(
    ...
    # 7. Suppress tool block & carriage
    cv2.rectangle(mask, (int(tip_x + 30), int(tip_y + 15)), (w, h), 0, -1)

    # 8. Unmask rightward ribbon flow corridor — confined strictly to air zone [tip_y - 60, tip_y + 15]
    cv2.rectangle(mask,
